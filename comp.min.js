...
var o=document.implementation.createHTMLDocument("");if(r){o.documentElement.innerHTML=n;return o.documentElement}else{o.body.innerHTML=n;return o.body.firstChild}};var j=O;var x="_set-dom-";var N=x+"index";var S=x+"mounted";var A=window.Node.ELEMENT_NODE;var C=window.Node.DOCUMENT_NODE;T.KEY="data-key";T.IGNORE="data-ignore";T.CHECKSUM="data-checksum";var _=T;/**
 * @description
 ...
 * @return {Object}
 */
function I(e){var n={};var t=e.length;var r;for(var o=0;o<t;o++){r=e[o];r[N]=o;n[H(r)||o]=r}return n}/**
 * @private
 * @description
 ...
 * @return {String}
 */
function H(e){if(e.nodeType!==A)return;var n=e.getAttribute(T.KEY)||e.id;if(n)n=x+n;return n&&x+n}/**
 * @private
 * @description
...
if(o===null)return null;if(a===0)return o;var m;var p;if(typeof o!="object"){return o}if(o instanceof e){m=new e}else if(o instanceof n){m=new n}else if(o instanceof t){m=new t(function(e,n){o.then(function(n){e(v(n,a-1))},function(e){n(v(e,a-1))})})}else if(r.__isArray(o)){m=[]}else if(r.__isRegExp(o)){m=new RegExp(o.source,f(o));if(o.lastIndex)m.lastIndex=o.lastIndex}else if(r.__isDate(o)){m=new Date(o.getTime())}else if(s&&Buffer.isBuffer(o)){m=new Buffer(o.length);o.copy(m);return m}else if(o instanceof Error){m=Object.create(o)}else{if(typeof u=="undefined"){p=Object.getPrototypeOf(o);m=Object.create(p)}else{m=Object.create(u);p=u}}if(i){var y=l.indexOf(o);if(y!=-1){return d[y]}l.push(o);d.push(m)}if(o instanceof e){var g=o.keys();while(true){var h=g.next();if(h.done){break}var b=v(h.value,a-1);var w=v(o.get(h.value),a-1);m.set(b,w)}}if(o instanceof n){var E=o.keys();while(true){var h=E.next();if(h.done){break}var O=v(h.value,a-1);m.add(O)}}for(var j in o){var x;if(p){x=Object.getOwnPropertyDescriptor(p,j)}if(x&&x.set==null){continue}m[j]=v(o[j],a-1)}if(Object.getOwnPropertySymbols){var N=Object.getOwnPropertySymbols(o);for(var j=0;j<N.length;j++){
// Don't need to worry about cloning a symbol because it is a primitive,
// like a number or string.
var S=N[j];var A=Object.getOwnPropertyDescriptor(o,S);if(A&&!A.enumerable&&!c){continue}m[S]=v(o[S],a-1);if(!A.enumerable){Object.defineProperty(m,S,{enumerable:false})}}}if(c){var C=Object.getOwnPropertyNames(o);for(var j=0;j<C.length;j++){var _=C[j];var A=Object.getOwnPropertyDescriptor(o,_);if(A&&A.enumerable){continue}m[_]=v(o[_],a-1);Object.defineProperty(m,_,{enumerable:false})}}return m}return v(o,a)}/**
