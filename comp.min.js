 ...
 */
function R(e,n){var t,r,o,i,a,u;var f=e.firstChild;var c=n.firstChild;var l=0;
// Extract keyed nodes from previous children and keep track of total count.
while(f){l++;t=f;r=F(t);f=f.nextSibling;if(r){if(!u)u={};u[r]=t}}
// Loop over new nodes and perform updates.
f=e.firstChild;while(c){l--;o=c;c=c.nextSibling;if(u&&(i=F(o))&&(a=u[i])){delete u[i];
// If we have a key and it existed before we move the previous node to the new position if needed and diff it.
if(a!==f){e.insertBefore(a,f)}else{f=f.nextSibling}I(a,o)}else if(f){t=f;f=f.nextSibling;if(F(t)){
...
for(r in u){l--;e.removeChild(u[r])}
 ...
 * @return {string|void}
 */
function F(e){if(e.nodeType!==T)return;var n=e.getAttribute(D.KEY)||e.id;if(n)return N+n}/**
...
if(F(e)){var t=document.createEvent("Event");var r={value:e};t.initEvent(n,false,false);Object.defineProperty(t,"target",r);Object.defineProperty(t,"srcElement",r);e.dispatchEvent(t)}
