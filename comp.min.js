...
var o=document.implementation.createHTMLDocument("");if(t){o.documentElement.innerHTML=n;return o.documentElement}else{o.body.innerHTML=n;return o.body.firstChild}};var b=N;var x="_set-dom-";var A=x+"index";var C=x+"mounted";var S=window.Node.ELEMENT_NODE;var O=window.Node.DOCUMENT_NODE;j.KEY="data-key";j.IGNORE="data-ignore";j.CHECKSUM="data-checksum";var T=j;/**
 * @description
...
R(e&&e.nodeType,"You must provide a valid node to update.");
...
q(e);e.parentNode.replaceChild(n,e);_(n)}}/**
 * @private
 * @description
 ...
 */
function I(e,n,r){var t,o,a,i,u;
 ...
 * @return {Object}
 */
function L(e){var n={};var r=e.length;var t;for(var o=0;o<r;o++){t=e[o];t[A]=o;n[k(t)||o]=t}return n}/**
 * @private
 * @description
 ...
 * @return {String}
 */
function k(e){if(e.nodeType!==S)return;var n=e.getAttribute(j.KEY)||e.id;if(n)n=x+n;return n&&x+n}/**
 * @private
 * @description
 ...
 * @return {String|NaN}
 */
function D(e){return e.getAttribute(j.CHECKSUM)||NaN}/**
 * @private
 * @description
 ...
 * @return {Boolean}
 */
function F(e){return e.getAttribute(j.IGNORE)!=null}/**
 ...
 * @throws Error
 */
function R(e,n){if(!e)throw new Error("set-dom: "+n)}function Y(e){return e&&e.__esModule?e["default"]:e}function K(e,n){return n={exports:{}},e(n,n.exports),n.exports}var P=K(function(e,n){"use strict";Object.defineProperty(n,"__esModule",{value:true});var r={"&":"&amp;",">":"&gt;","<":"&lt;",'"':"&quot;","'":"&#39;","`":"&#96;"};var t=new RegExp(Object.keys(r).join("|"),"g");n["default"]=function(){var e=arguments.length<=0||arguments[0]===undefined?"":arguments[0];return String(e).replace(t,function(e){return r[e]})};e.exports=n["default"]});var V=Y(P);
// Source: http://www.2ality.com/2015/01/template-strings-html.html#comment-2078932192
var B=function(e){for(var n=arguments.length,r=Array(n>1?n-1:0),t=1;t<n;t++){r[t-1]=arguments[t]}return e.raw.reduce(function(e,n,t){var o=r[t-1];if(Array.isArray(o)){o=o.join("")}if(e.endsWith("@")){o=V(o);e=e.slice(0,-1)}return e+o+n})};var G={};function z(e,n,r,t){r(t);var o={};Object.keys(n).map(function(e){o[e]=function(){for(var o=arguments.length,a=Array(o),i=0;i<o;i++){a[i]=arguments[i]}var u=n[e].apply(n,a);if(u&&u.then){J(u,r)}r(t)}},this);o.name=e;o.get=function(e){return t[e]};return o}function J(e,n){e.then(function(e){if(e==null){throw new Error("No model received: aborting render")}n(e)}).catch(function(e){if(typeof e==="string"){console.error(e)}else{console.error("Error unhandled by component. Add a catch handler to your AJAX method.")}})}function W(e,n,r,t){if(e==null||e===""){throw new Error("Your component needs a name")}if(n==null){var o="// It must be a function that takes a model and returns an object of functions, e.g.\r\n\r\nYourComponent.Actions = function (model) {\r\n    return {\r\n        sayHello: function () { console.log('Hi.'); },\r\n        greet: function (name) { console.log('Hello, ' + name); }\r\n    }\r\n}";throw new Error(e+" needs some actions! Here's an example of an Actions function:\r\n\r\n"+o+"\r\n\r\n")}var a=r&&r();var i=a&&a.init?a.init:function(){};var f=a&&a.render?function(n){var r=a.render(n,B);if(typeof document!=="undefined"&&r){var t=document.querySelector("[data-component="+e+"]");if(t){if(t.innerHTML===""){t.innerHTML=r}else{T(t.firstElementChild,r)}}}}:function(){};var c=z(e,n(t),f,t);G[e]=c;if(typeof document!=="undefined"&&typeof m!=="undefined"){c=u(c)}i(c,t);return c}var X={components:G,create:W};return X});
