...
j(e);e.parentNode.replaceChild(n,e);O(n)}}/**
 * @private
 * @description
 ...
 * @return {Object}
 */
function A(e){var n={};var t=e.length;var r;for(var o=0;o<t;o++){r=e[o];r[h]=o;n[S(r)||o]=r}return n}/**
 * @private
 * @description
 ...
 * @return {String}
 */
function S(e){if(e.nodeType!==y)return;var n=e.getAttribute(b.KEY)||e.id;if(n)n=p+n;return n&&p+n}/**
 * @private
 * @description
 ...
 * @return {String|NaN}
 */
function M(e){return e.getAttribute(b.CHECKSUM)||NaN}/**
 * @private
 * @description
 ...
 * @return {Boolean}
 */
function T(e){return e.getAttribute(b.IGNORE)!=null}/**
...
if(S(e))H(e,"mount");
// Mount all children.
var n=e.firstChild;while(n){O(n);n=n.nextSibling}}/**
