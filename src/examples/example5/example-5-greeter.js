...
Example5.Greeter.Actions = (model) => {
...
Example5.Greeter.View = () => {
    ...
    return {
        init: (actions, model) => {
            ...
            BUTTONS_SHOW_MODAL.on("click", () => { comp.components.modal.show(model.fullGreeting); });
        },
        render: (model) => {
...
comp.create("greeter", Example5.Greeter.Actions, Example5.Greeter.View, {
    name: "",
    greeting: "",
    fullGreeting: ""
});